...
function Receipant () {
  ...
  <div className="mt-6 border border-gray-200 p-4 rounded-lg space-y-4 dark:border-gray-700">
    <div className="hidden sm:grid sm:grid-cols-5">
      ...
      <div className="text-start text-xs font-medium text-gray-500 uppercase">Weight</div>
    ...
    <div className="grid grid-cols-3 sm:grid-cols-5 gap-2">
      ...
      <div>
        <h5 className="sm:hidden text-xs font-medium text-gray-500 uppercase">Weight</h5>
    ...
    <div className="w-full max-w-2xl sm:text-end space-y-2">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-1 gap-3 sm:gap-2">
        <dl className="grid sm:grid-cols-5 gap-x-3 text-sm">
          ...
          <dd className="col-span-2 font-medium text-gray-800 dark:text-gray-200">35kg</dd>
        </dl>
        <dl className="grid sm:grid-cols-5 gap-x-3 text-sm">
      ...
      <div >
      <Button onClick={downloadPDF} style={{justifyItems:"center"}}>Print Receipt</Button>
      </div>
      </>
