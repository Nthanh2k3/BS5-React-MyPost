...
export default function SidebarForWM({ warehouseId }) {
    var encodedId = btoa(warehouseId);
    return (
        <>
            {/* Sidenav */}
            <nav
                id="sidenav-8"
                className="sticky left-0 z-[1035] w-60 h-screen -translate-x-full overflow-hidden bg-white shadow-[0_4px_12px_0_rgba(0,0,0,0.07),_0_2px_4px_rgba(0,0,0,0.05)] data-[te-sidenav-hidden='false']:translate-x-0 dark:bg-zinc-800"
                    ...
                    <li className="relative pt-4">
                        ...
                        >
                            <span className="ml-2 mr-4 [&>svg]:h-5 [&>svg]:w-5 [&>svg]:text-gray-400 dark:[&>svg]:text-gray-300">
                                ...
                                <span className="text-sm font-quick mr-10">Warehouse Staff</span>
                            </span>
                        </Link>
                    </li>
                    <li className="relative pt-4">
